...
export default {
  head () {
    return {
      title: 'Articles by Matt Shull',
      meta: [
        { hid: 'description', name: 'description', content: 'Matt Shull has written many blog posts over the years and continues to write about web performance, Vue.js, web components, and more.  This is a collection of those blog posts.' },
		{ name: 'twitter:card', content: 'article' },
		{ name: 'twitter:site', content: '@themattshull' },
		{ name: 'twitter:title', content: "Articles by Matt Shull" },
		{ name: 'twitter:description', content: "Matt Shull has written many blog posts over the years and continues to write about web performance, Vue.js, web components, and more.  This is a collection of those blog posts." },
		{ name: 'twitter:image', content: '~/assets/img/logo-head.jpg' },
		{ name: 'twitter:image:alt', content: 'Image of Matt Shull' },
		{ property: 'og:type', content: 'article' },
		{ property: 'og:title', content: "Articles by Matt Shull" },
		{ property: 'og:description', content: "Matt Shull has written many blog posts over the years and continues to write about web performance, Vue.js, web components, and more.  This is a collection of those blog posts." },
